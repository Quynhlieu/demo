...
//		Node result = algo1.execute(nodeS, "G");// Task1
//		NodeUtils.printPath(result1);
//		Node result1 = algo1.execute(nodeS, "A", "G");//Task2
//		NodeUtils.printPath(result1);
//		Node result1 = algo1.executeTreeSearch(nodeS, "G");
//		NodeUtils.printPath(result1);
//		Node result1 = algo1.executeTreeSearch(nodeS,"A", "G");
//		NodeUtils.printPath(result1);
		
		
		ISearchAlgo algo2 = new DepthFirstSearchAlgo();
//		Node result2 = algo2.execute(nodeS, "G");
//		NodeUtils.printPath(result2);
//		Node result2 = algo2.execute(nodeS,"A", "G");
//		NodeUtils.printPath(result2);
//		Node result2 = algo2.executeTreeSearch(nodeS, "G");// Task3
//		NodeUtils.printPath(result2);
		Node result2 = algo2.executeTreeSearch(nodeS, "A", "G");//Task3
		NodeUtils.printPath(result2);
	}
}
